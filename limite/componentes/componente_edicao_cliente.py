...
class ComponenteEdicaoCliente:
  def __init__(self, cliente_dto):
    print('componente', cliente_dto.nome)
    ...
    cliente_edicao_layout = [
      ...
      [sg.Text('cpf:', size=(7,1)), sg.InputText(cliente_dto.cpf, key='it_edicao_cliente_cpf', size=(25,1), do_not_clear=False)],
