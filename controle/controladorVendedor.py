...
class ControladorVendedor:
  ...
  def adicionar_vendedor(self, vendedor: Vendedor):
    ...
    self.__tela_vendedor.mostrar_mensagem("O Vendedor foi cadastrado com sucesso!")
  ...
  def excluir_vendedor(self, codigo_vendedor: int):
    ...
    self.__tela_vendedor.mostrar_mensagem("O vendedor foi removido com sucesso!")

  def __encontrar_vendedor(self, codigo_vendedor: int):
  ...
  def alterar_vendedor(self):
    ...
    self.__tela_vendedor.mostrar_mensagem("O vendedor foi alterado com sucesso!")

  def mostrar_tela_opcoes(self):
    opcoes = {1: self.adicionar_vendedor,
